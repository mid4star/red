         ...
         <div className="relative z-30 max-w-7xl mx-auto w-full text-center">
            ...
            >
               <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.4em] text-teal-400 italic">{heroAuthorityVal}</span>
                  <div className="w-12 h-px bg-teal-500/50" />
               </div>
               ...
               <div className="pt-12 flex flex-col sm:flex-row items-center justify-center gap-6">
                  ...
                  <Link href={getLocalizedLink(heroBtn2LinkVal)} className="no-underline text-white">
            ...
            <div className="w-full lg:w-1/2 space-y-10">
               <div className="space-y-2">
                  <div className="flex items-center gap-2">
                     <span className="text-[11px] font-black text-teal-500 uppercase tracking-[0.3em] italic">{missionTagVal}</span>
                  </div>
               ...
               <div className="flex gap-8">
                  <div className="space-y-4">
                     {missionChecklistVal.slice(0, 2).map((item, index) => (
                       <div key={index} className="flex items-center gap-3 text-white font-black text-sm uppercase italic">
            ...
            <div className="w-full lg:w-1/2 mt-20 lg:mt-0 relative">
               <div className="w-full aspect-[4/3] lg:aspect-square rounded-[2rem] lg:rounded-[3rem] overflow-hidden border border-white/10 relative group">
                  ...
                  <div className="absolute bottom-4 left-4 p-5 sm:bottom-8 sm:left-8 sm:p-8 rounded-3xl bg-slate-900/80 backdrop-blur-xl border border-white/10 max-w-xs">
                     ...
                     <p className="text-xs font-black uppercase tracking-widest text-[#94a3b8] mb-1 italic">{missionCardTagVal}</p>
                     <p className="text-lg font-black italic tracking-tighter uppercase">{missionCardTitleVal}</p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
               <div className="space-y-3">
                  <span className="text-[11px] font-black text-teal-400 uppercase tracking-[0.3em] italic">{highlightsTagVal}</span>
                  <h2 className="text-3xl md:text-5xl lg:text-7xl font-black uppercase italic tracking-tighter leading-tight lg:leading-[1.1]">{highlightsTitleVal}</h2>
               </div>
               <Link href={getLocalizedLink(highlightsLinkUrlVal)} className="group flex items-center gap-3 text-[12px] font-black text-teal-400 uppercase tracking-widest italic no-underline">
