...
import {
  ...
  FileText, Download, Archive, Globe
} from 'lucide-react';
      ...
      <AnimatePresence>
        {showEditor && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-start justify-center pt-10 overflow-y-auto"
            ...
            <motion.div initial={{ opacity: 0, y: 40, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 40 }}
              className="w-full max-w-2xl bg-[#0d1b2a] rounded-3xl border border-white/10 shadow-2xl mb-10">
