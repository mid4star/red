...
import {
  ...
  Image as ImageIcon, Save, FileText, Globe
} from 'lucide-react';
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-white/5">
                ...
                <button onClick={() => setShowEditor(false)} className="p-2 rounded-xl bg-white/5 text-slate-400 hover:text-white hover:bg-white/10 transition-all">
                  <X size={18} />
                </button>
              </div>
