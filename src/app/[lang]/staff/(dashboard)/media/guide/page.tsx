      ...
      <AnimatePresence>
        ...
        {showGuideEditor && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            onClick={(e) => e.target === e.currentTarget && setShowGuideEditor(false)}>
            <motion.div initial={{ opacity: 0, y: 40, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 40 }}
              className="w-full max-w-3xl bg-[#0d1b2a] rounded-3xl border border-white/10 shadow-2xl mb-10 overflow-hidden">
              <div className="flex items-center justify-between p-6 border-b border-white/5">
                <h2 className="text-lg font-bold text-white">
                  {editingId ? (isAr ? 'تعديل القسم' : 'Edit Section') : (isAr ? 'قسم جديد' : 'New Section')}
                </h2>
                <button onClick={() => setShowGuideEditor(false)} className="p-2 rounded-xl bg-white/5 text-slate-400 hover:text-white transition-all"><X size={18} /></button>
              </div>
              ...
              <div className="flex items-center justify-between p-6 border-t border-white/5 bg-[#0a1628]">
                {editingId && (
                ...
                <div className={`flex gap-3 ${!editingId ? 'ml-auto' : ''}`}>
                  <Button intent="outline" onClick={() => setShowGuideEditor(false)} className="border-white/10 bg-white/5 text-slate-300">{isAr ? 'إلغاء' : 'Cancel'}</Button>
        ...
        {showSpeciesEditor && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-start justify-center pt-8 overflow-y-auto"
            onClick={(e) => e.target === e.currentTarget && setShowSpeciesEditor(false)}>
            <motion.div initial={{ opacity: 0, y: 40, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 40 }}
              className="w-full max-w-3xl bg-[#0d1b2a] rounded-3xl border border-white/10 shadow-2xl mb-10 overflow-hidden">
              <div className="flex items-center justify-between p-6 border-b border-white/5">
                <h2 className="text-lg font-bold text-white">
                ...
                <button onClick={() => setShowSpeciesEditor(false)} className="p-2 rounded-xl bg-white/5 text-slate-400 hover:text-white transition-all"><X size={18} /></button>
              </div>
              ...
              <div className="flex items-center justify-between p-6 border-t border-white/5 bg-[#0a1628]">
                ...
                <div className={`flex gap-3 ${!editingId ? 'ml-auto' : ''}`}>
                  <Button intent="outline" onClick={() => setShowSpeciesEditor(false)} className="border-white/10 bg-white/5 text-slate-300">{isAr ? 'إلغاء' : 'Cancel'}</Button>
        ...
        {/* Terrain Location Editor Modal */}
        {showTerrainEditor && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-start justify-center pt-8 overflow-y-auto"
            onClick={(e) => e.target === e.currentTarget && setShowTerrainEditor(false)}>
            <motion.div initial={{ opacity: 0, y: 40, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 40 }}
              className="w-full max-w-3xl bg-[#0d1b2a] rounded-3xl border border-white/10 shadow-2xl mb-10 overflow-hidden">
              <div className="flex items-center justify-between p-6 border-b border-white/5">
                <h2 className="text-lg font-bold text-white">
                ...
                <button onClick={() => setShowTerrainEditor(false)} className="p-2 rounded-xl bg-white/5 text-slate-400 hover:text-white transition-all"><X size={18} /></button>
              </div>
              ...
              <div className="flex items-center justify-between p-6 border-t border-white/5 bg-[#0a1628]">
                ...
                <div className={`flex gap-3 ${!editingId ? 'ml-auto' : ''}`}>
                  <Button intent="outline" onClick={() => setShowTerrainEditor(false)} className="border-white/10 bg-white/5 text-slate-300">{isAr ? 'إلغاء' : 'Cancel'}</Button>
