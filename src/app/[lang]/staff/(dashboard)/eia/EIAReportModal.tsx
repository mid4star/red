                ...
                <div className="flex flex-col gap-2">
                  {item.files.map((f: any, idx: number) => (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-3 px-5 py-3 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white rounded-xl text-sm font-bold transition-all group w-fit max-w-full"
                    >
                      <div className="w-8 h-8 rounded-lg min-w-8 bg-white dark:bg-black/20 flex items-center justify-center text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform">
                         <FileText size={16} />
                      </div>
